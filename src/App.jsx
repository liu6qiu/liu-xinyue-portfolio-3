...
function OtherWorkDemo() {
  ...
  return <section className="other-work" aria-labelledby="other-work-title">
    ...
    <div className="other-work-stage">
      <DepthCarousel items={items} cardWidth={640} cardHeight={320} radius={5} depth={105} spread={132} tilt={3} perspective={1900} visibleCards={4} falloff={0.12} blur={3.5} duration={1000} ease="power3.inOut" autoPlay autoPlayDelay={5000} loop showControls showIndicators={false} />
    </div>
  </section>;
}
